...
interface ChatSidePanelProps {
  ...
  /** Bouncing-dot typing state for client-side delayed replies */
...
export function ChatSidePanel({
  ...
  return (
    <div className="flex h-full flex-col">
      {/* Panel header — matches ppp-prototype-share/components/lihp/chat-side-panel */}
      <div className="flex items-center justify-between border-b border-[#dae1ed] px-4 py-3">
        <SparkleIcon className="h-5 w-5" />
        <div className="flex items-center gap-3">
          <button type="button" className="text-[#5b6780] hover:text-[#0f1114]">
          ...
          <button
            ...
            onClick={onClose}
            className="text-[#5b6780] hover:text-[#0f1114]"
          >
      ...
      <div className="flex-1 overflow-hidden">
        <ChatPanel
          ...
          pendingLocalReply={pendingLocalReply}
