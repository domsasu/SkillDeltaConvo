...
interface HeaderProps {
  ...
  /** Toggle or open the learning coach panel from the header sparkle control. */
  onToggleCoach?: () => void;
}
          ...
          <div className="flex items-center gap-4 text-[var(--cds-color-grey-500)] mr-2">
             ...
             {onToggleCoach && (
               <button
                 ...
                 aria-label={coachPanelOpen ? 'Close learning coach' : 'Open learning coach'}
                 aria-pressed={coachPanelOpen}
                 className={`flex h-9 w-9 shrink-0 items-center justify-center rounded-full transition-colors ${
                   coachPanelOpen
                     ? 'bg-[var(--cds-color-blue-25)] text-[var(--cds-color-blue-700)] ring-2 ring-[var(--cds-color-blue-100)]'
                     : 'text-[var(--cds-color-grey-500)] hover:bg-[var(--cds-color-grey-50)] hover:text-[var(--cds-color-grey-975)]'
                 }`}
               >
                ...
                {onToggleCoach && (
                  <button
                    ...
                    className={`flex h-9 w-9 shrink-0 items-center justify-center rounded-full transition-colors ${
                      coachPanelOpen
                        ? 'bg-[var(--cds-color-blue-25)] text-[var(--cds-color-blue-700)] ring-2 ring-[var(--cds-color-blue-100)]'
                        : 'text-[var(--cds-color-grey-500)] hover:bg-[var(--cds-color-grey-50)] hover:text-[var(--cds-color-grey-700)]'
                    }`}
                  >
                    <SparkleIcon className="h-5 w-5" />
                  </button>
