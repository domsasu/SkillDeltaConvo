  ...
  return (
    ...
    <div className="flex flex-col h-screen bg-[var(--cds-color-grey-25)] text-[var(--cds-color-grey-975)]">
      <Header 
        ...
        onToggleCoach={() => setCoachPanelOpen((open) => !open)}
      />
      ...
      <div className="flex flex-1 overflow-hidden relative bg-[var(--cds-color-white)]">
        ...
        {/* PPP lihp-page: aside w-[400px] shrink-0 flex-col bg-white */}
        <aside
          className={`shrink-0 overflow-hidden border-l border-[#dae1ed] bg-white transition-[width] duration-300 ease-out ${
            coachPanelOpen ? "w-[400px]" : "w-0"
          }`}
        >
